  ...
  .Modal-call .Round-icon--off {
    ...
    @media screen and (min-width: 600px) {
      .Modal-call .Round-icon--off {
        ...
        position: absolute; } }
  .Modal-call__label-wrapper {
    margin-bottom: 24px; }
    .Modal-call__label-wrapper label {
      font-size: 24px;
      font-weight: 600; }
    .Modal-call__label-wrapper label::before {
      content: url(${___CSS_LOADER_URL_REPLACEMENT_22___});
      position: relative;
      left: -16px;
      top: 10px; }
  ...
  .Modal-feedback .Round-icon--off {
    ...
    @media screen and (min-width: 600px) {
      .Modal-feedback .Round-icon--off {
        transform: translate(-80px, 10px);
        position: absolute; } }
  .Modal-feedback__label-wrapper {
    margin-bottom: 24px; }
    .Modal-feedback__label-wrapper label {
      font-size: 24px;
      font-weight: 600; }
    .Modal-feedback__label-wrapper label::before {
      content: url(${___CSS_LOADER_URL_REPLACEMENT_22___});
      position: relative;
      left: -16px;
      top: 10px; }
...
/******/ })()
;
//# sourceMappingURL=main.527f69bfa523e059b19e.js.map